...
(function() {
  var FPS, NB_FRAMES, chainAsync, clear_depth_map, createAnimation, depth_map_sketch, download, main, runWiggle, setupToolbox, upload_image;
  ...
  runWiggle = function() {
    ...
    return window.animation.play($("#result")[0], 20);
  };
