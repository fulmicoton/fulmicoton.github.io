...
(function() {
  var core, eventcaster, form, model, utils, view, widget;
  ...
  List = Literal({
    ...
    toData: function(obj) {
      ...
      for (_i = 0, _len = obj.length; _i < _len; _i++) {
        it = obj[_i];
        _results.push(this.__potato__.itemType.toData(it));
      }
      return _results;
    },
...
// Generated by CoffeeScript 1.3.3
(function() {
  var SPLIT_ONCE_PER_TYPE, extend, genericSplitOnce, log, mapDict, pick, regexSplitOnce, removeEl, rextend, split, stringSplitOnce, twoRecursiveExtend,
    __slice = [].slice;
  ...
  twoRecursiveExtend = function(dest, extra) {
    ...
    for (k in extra) {
      v = extra[k];
      if ((typeof v) === "object" && (v != null) && !(v.length != null)) {
        if (!(dest[k] != null)) {
          dest[k] = {};
        }
        rextend(dest[k], v);
...
// Generated by CoffeeScript 1.3.3
(function() {
  var Boolean, CollectionOf, Integer, Model, NonEmptyString, String, core, eventcaster, model, utils;
  ...
  CollectionOf = function(itemType) {
    return Model({
      ...
      methods: {
        ...
        toData: function() {
          return this.__potato__.__content___.components.items.toData(this);
        },
  ...
  View = View({
    ...
    methods: {
      ...
      renderTemplate: function() {
        ...
        this.el.html(this.__potato__.__template__(this.context()));
        _ref = this.components();
        _results = [];
    ...
    return View({
      ...
      methods: {
        ...
        setModel: function(itemModelList) {
          ...
          return this.buildItemsFromModel();
        },
...
require.define("/node_modules/hogan/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"./lib/hogan.js"}
});

require.define("/node_modules/hogan/lib/hogan.js", function (require, module, exports, __dirname, __filename) {
/*
...
require.define("/node_modules/hogan/lib/compiler.js", function (require, module, exports, __dirname, __filename) {
/*
 *  Copyright 2011 Twitter, Inc.
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
require.define("/node_modules/hogan/lib/template.js", function (require, module, exports, __dirname, __filename) {
/*
 *  Copyright 2011 Twitter, Inc.
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
// Generated by CoffeeScript 1.3.3
(function() {
  var Form, FormFactory, InputForm, IntegerForm, JSONForm, PotatoView, PotatoViewOf, core, model, utils, view,
    __slice = [].slice;
    ...
    methods: {
      ...
      val: function() {
        ...
        if (args.length === 0) {
          ...
          return this.set_val.apply(this, args);
        }
      },
      get_val: function() {
        return void 0;
  ...
  JSONForm = Form({
    ...
    methods: {
      ...
      set_val: function(val) {
        return this.el.val(JSON.stringify(val));
      }
    }
  });
...
// Generated by CoffeeScript 1.3.3
(function() {
  var MenuItem, TabMenu, TemplateView, core, model, view;
  ...
  TemplateView = TemplateView({
    ...
    methods: {
      render: function(parent) {
        var context;
        context = this.__potato__.__extract_context__.apply(parent);
        return this.el.html(this.__potato__.__template__(context));
      }
    }
  });
